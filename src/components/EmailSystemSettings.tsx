          ...
          <>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">VerschlÃ¼sselte Ãœbertragung verwenden</p>
              </div>
              <Switch
    ...
    <div className={`space-y-6 ${className}`}>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Konfiguration des E-Mail-Systems fÃ¼r die gesamte Anwendung</p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">E-Mail-Funktionen fÃ¼r die Anwendung aktivieren</p>
                </div>
                <Switch
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-gray-600">Maximale Wartezeit fÃ¼r E-Mail-Versand</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                />
                <p className="text-sm text-gray-600">E-Mail-Adressen fÃ¼r Kopien aller ausgehenden E-Mails (durch Komma getrennt)</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label>Initiale VerzÃ¶gerung (Sekunden)</Label>
                    <Input
                      type="number"
                      min="1"
                      max="300"
                  ...
                  <div className="space-y-2">
                    <Label>Maximale VerzÃ¶gerung (Sekunden)</Label>
                    <Input
                      type="number"
                      min="60"
                      max="3600"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="font-medium">E-Mail-Ã–ffnungen verfolgen</Label>
                    <p className="text-sm text-gray-600">Tracking-Pixel fÃ¼r geÃ¶ffnete E-Mails hinzufÃ¼gen</p>
                  </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-gray-600">URL fÃ¼r E-Mail-Event-Benachrichtigungen</p>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700 mt-1">
              Stellen Sie sicher, dass alle Einstellungen in einer Produktionsumgebung ordnungsgemÃ¤ÃŸ
              konfiguriert und getestet sind. Sensible Daten wie PasswÃ¶rter und API-Keys sollten
